...
#  Default: 'python3'
c.MultiKernelManager.default_kernel_name = "python-3.8"
...
c.MappingKernelManager.default_kernel_name = "python-3.8"
...
#  Choices: any of [
#    'sha3_224', 'blake2s', 'sha3_384', 'md5', 'sha1', 'sha3_256', 'sha384',
#    'blake2b', 'sha256', 'sha3_512', 'sha224', 'sha512'
#  ]
#  Default: 'sha256'
...
## The name of the default kernel to start
#  See also: MultiKernelManager.default_kernel_name
c.GatewayKernelManager.default_kernel_name = "python-3.8"
...
c.GatewayKernelSpecManager.ensure_native_kernel = False
