...
# export COGNITO_EXTERNAL_PROVIDER=None
# export COGNITO_EXTERNAL_PROVIDER_LABEL=None
# export COGNITO_EXTERNAL_PROVIDER_DOMAIN=
# export COGNITO_EXTERNAL_PROVIDER_REDIRECT=
