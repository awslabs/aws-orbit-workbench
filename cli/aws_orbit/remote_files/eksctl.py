...
def create_nodegroup_structure(context: "Context", nodegroup: ManagedNodeGroupManifest) -> Dict[str, Any]:
    labels = {"orbit/node-group": nodegroup.name, "orbit/usage": "teams", "orbit/node-type": "ec2", "node-group": nodegroup.name, "usage": "teams", "node-type": "ec2"}
...
def generate_manifest(context: "Context", name: str, nodegroups: Optional[List[ManagedNodeGroupManifest]]) -> str:
    ...
    labels = {"orbit/node-group": "env", "orbit/usage": "reserved", "orbit/node-type": "ec2", "node-group": "env", "usage": "reserved", "node-type": "ec2"}
